 ...
 */
public class FragmentGridAdapter extends RecyclerView.Adapter<FragmentGridAdapter.MyViewHolder> {

    private Context context;
    private MainMvpView mainMvpView;

    public FragmentGridAdapter(Context context, MainMvpView mainMvpView) {
        super();
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.fragment_grid_items, viewGroup, false);
