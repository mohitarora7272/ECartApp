 ...
 */
public class FragmentListAdapter extends RecyclerView.Adapter<FragmentListAdapter.MyViewHolder> {

    private Context context;
    private MainMvpView mainMvpView;

    public FragmentListAdapter(Context context, MainMvpView mainMvpView) {
        super();
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.fragment_list_items, viewGroup, false);
