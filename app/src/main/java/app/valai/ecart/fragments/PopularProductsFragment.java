 ...
 */
public class PopularProductsFragment extends BaseFragment {
    public static final String TAG = PopularProductsFragment.class.getSimpleName();
    ...
    public static PopularProductsFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_popular_products, container, false);
